...
@section('title', 'Survei Penduduk Baru')
...
<div class="space-y-6 max-w-4xl mx-auto">
    <div class="flex items-center gap-4">
        ...
        <div>
            <h2 class="text-2xl font-bold text-gray-900 tracking-tight">Formulir Survei Penduduk</h2>
            <p class="text-sm text-gray-500 mt-1">Kumpulkan data demografi penduduk di lapangan.</p>
        </div>
    </div>
    ...
    <form action="{{ route('mitra.survei.penduduk.store') }}" method="POST" class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        @csrf
        ...
        <div class="p-6 sm:p-8 space-y-8">
            ...
            <!-- Geotagging -->
            <div>
                <h3 class="text-lg font-semibold text-gray-900 border-b border-gray-100 pb-2 mb-4">Geotagging Lokasi</h3>
                <p class="text-sm text-gray-500 mb-3">Geser pin merah untuk menandai lokasi rumah yang disurvei.</p>
            ...
            <div>
                ...
                <textarea name="catatan" rows="3" class="w-full py-2 px-3 bg-yellow-50 border border-yellow-200 rounded-lg focus:ring-2 focus:ring-emerald-200 focus:border-emerald-500 transition-colors" placeholder="Tambahkan catatan khusus dari lapangan (opsional)...">{{ old('catatan') }}</textarea>
            </div>
        </div>
